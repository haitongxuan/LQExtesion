...
namespace LQExtension
{
    public class LQExtensionUser
    {
        public LQExtensionUser(ClaimsPrincipal user)
        {
            this.User = user;
    ...
    public static class LQExtensionFactory
    {
        public static LQExtensionUser GetLQExtensionUser(ClaimsPrincipal user)
        {
            return new LQExtensionUser(user);
        }
    }
}
